...
const Rankings = () => {
  ...
  const sortedData = data
    .slice()
    .sort((a, b) => b["HOF Probability"] - a["HOF Probability"]);
  ...
  return (
    <Flex p="10" flexDir="column">
      ...
      <Heading className={styles.probsText}>
        Hall of Fame probabilities: Current and former players
      </Heading>
            ...
            <Tbody>
              {displayedData.map((row, index) => (
                <Tr
                  key={index}
                  color={
                    index === 0 ? "#E1AA0F" : index === 3 ? "green" : undefined
                  }
                >
